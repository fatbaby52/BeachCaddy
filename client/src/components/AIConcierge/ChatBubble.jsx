...
const ChatBubble = memo(function ChatBubble() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed bottom-28 right-4 z-50 w-[380px] max-w-[calc(100vw-2rem)] rounded-2xl shadow-2xl overflow-hidden',
      ...
      {!isOpen && !hasInteracted && (
        <div className="fixed bottom-36 right-20 z-50 animate-fade-in">

        ...
        <Card className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-sm text-ocean-500 hover:text-ocean-600">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-3 border border-sand-200 rounded-lg hover:bg-sand-50 transition-colors">
